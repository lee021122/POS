...
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'supplier_id', 'id', 9, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'pricing_type_id', 'id', 10, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'cost', 'money', 11, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'sell_price', 'money', 12, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'tax_code1', 'string', 13, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'amt_include_tax1', 'int', 14, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'tax_code2', 'string', 15, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'amt_include_tax2', 'int', 16, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'calc_tax2_after_tax1', 'int', 17, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'is_in_use', 'int', 18, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'display_seq', 'string', 19, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'is_enable_kitchen_printer', 'int', 20, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'is_allow_modifier', 'int', 21, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'is_enable_track_stock', 'int', 22, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'is_popular_item', 'int', 23, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'meal_period', 'text', 24, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'rid', 'int', 25, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'axn', 'string', 26, 1, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'url', 'string', 27, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bcc1296e-0f45-4d02-be5b-f110a1681c0c', 'is_debug', 'int', 28, 0, current_timestamp, 'admin'),
-- prod-setup::l
...
(gen_random_uuid(), '42fb72be-22d0-4f39-95db-377367c2d00f', 'rid', 'int', 7, 0, current_timestamp, 'admin'),
(gen_random_uuid(), '42fb72be-22d0-4f39-95db-377367c2d00f', 'axn', 'string', 8, 0, current_timestamp, 'admin'),
(gen_random_uuid(), '42fb72be-22d0-4f39-95db-377367c2d00f', 'url', 'string', 9, 0, current_timestamp, 'admin'),
(gen_random_uuid(), '42fb72be-22d0-4f39-95db-377367c2d00f', 'is_debug', 'int', 10, 0, current_timestamp, 'admin'),
-- prod-modifier::gl
...
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'store_name', 'string', 4, 1, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'addr_line_1', 'string', 5, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'addr_line_2', 'string', 6, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'city', 'string', 7, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'state', 'id', 8, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'post_code', 'string', 9, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'country', 'id', 10, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'phone_number', 'string', 11, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'email', 'string', 12, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'website', 'string', 13, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'gst_id', 'string', 14, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'sst_id', 'string', 15, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'business_registration_num', 'string', 16, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'receipt_temp_id', 'id', 17, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'rid', 'int', 18, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'axn', 'string', 19, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'url', 'string', 20, 0, current_timestamp, 'admin'),
(gen_random_uuid(), 'bd23cb72-e6be-4e1c-b61f-d9c6a21adc85', 'is_debug', 'int', 21, 0, current_timestamp, 'admin'),
-- setting-store::l
...
(gen_random_uuid(), 'c9b99fa5-de79-4196-89b6-8aea912143a5', 'is_in_use', 'integer', 11, 0, current_timestamp, 'admin'),
