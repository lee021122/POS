...
AppPymtMode.prototype.pymtModeObject = function(o = {}) {
    ...
    const conversionMap = {
        ...
        pymt_mode_desc: libShared.toString,      
        pymt_type: libShared.toInt,
...
AppPymtMode.prototype.pymtTypeList = async function (req, res) {
    let validAxn, params;
...
router.post('/l', pymt.list.bind(pymt));
router.post('/ptl', pymt.pymtTypeList.bind(pymt));
router.post('/s', auth.checkPermission.bind(auth, `${SERVICE}::s`), (req, res) => {
    pymt.save.bind(req, res);
});
